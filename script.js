...
async function playMovie(id) {
    ...
    // Server vidsrc.xyz otomatis memuat subtitle indonesia jika tersedia di database sistem player
    const embedUrl = `https://vidsrc.xyz/embed/movie/${id}`;
    // Link download eksternal alternatif
    const downloadUrl = `https://vidsrc.xyz/download/movie/${id}`;
    ...
    modalBody.innerHTML = `
        ...
        <div class="download-wrapper">
            <a href="${downloadUrl}" target="_blank" class="btn-download">
                <i class="fas fa-download"></i> Download Film Ini (Server Utama)
            </a>
        </div>
